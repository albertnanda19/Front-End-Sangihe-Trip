    ...
    <section className="relative h-[600px] flex items-center justify-center overflow-hidden z-0">
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        ...
        <p className="text-xl md:text-2xl mb-8 text-sky-100 max-w-2xl mx-auto">
          Temukan destinasi tersembunyi, budaya lokal, dan kuliner khas di
          kepulauan yang memukau
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button
            size="lg"
            className="cursor-pointer bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 text-lg"
          >
            Mulai Rencana
          </Button>
          <Button
